...
public class NetworkMessage implements Streamable, Serializable {
    ...
    public void readFrom(DataInputStream dis) throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        header = (NetworkHeader) StreamUtil.readStreamableFrom(dis);
        ...
        if (dis.readBoolean()) {
            ...
            attachments = (List<StreamableAttachment>) StreamUtil.readStreamablesFrom(dis);
        }
        //noinspection unchecked
        hops = (List<NetworkHop>) StreamUtil.readStreamablesFrom(dis);
    ...
    public void writeTo(DataOutputStream dos) throws IOException {
        StreamUtil.writeStreamableTo(dos, header);
        ...
        if (attachments == null) {
            ...
            StreamUtil.writeStreamablesTo(dos, attachments);
        }
        StreamUtil.writeStreamablesTo(dos, hops);
