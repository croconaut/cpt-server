...
public class NetworkHeader implements Streamable, Comparable<NetworkHeader>, Serializable {
    ...
    public void readFrom(DataInputStream dis) throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        rowId = dis.readLong();
        identifier = (MessageIdentifier) StreamUtil.readStreamableFrom(dis);
    ...
    public void writeTo(DataOutputStream dos) throws IOException {
        dos.writeLong(rowId);
        StreamUtil.writeStreamableTo(dos, identifier);
